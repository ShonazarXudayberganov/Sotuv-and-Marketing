...
9. 🟡 Asosiy tahlil (post statistikasi, AI o‘rganish) — analytics bor; Meta publication snapshot uchun real `likes/comments/shares` va `views/reach` pull qo‘shildi, YouTube publication snapshot uchun real `views/likes/comments` pull qo‘shildi; Telegram metrics va AI learning hali yo‘q
